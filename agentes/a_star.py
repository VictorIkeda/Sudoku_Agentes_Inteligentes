...
from .buscadores.busca import A_estrela
import time

class AgenteAEstrela(AgenteAbstrato):
    def __init__(self) -> None:
        super().__init__()
        self.problema: heuristica = heuristica(heuristica.estado_inicial())
        self.no_solucao = A_estrela(self.problema)
    ...
    def adquirirPercepcao(self, percepcao_mundo: PercepcoesJogador):
        ...
        '''
        AgenteAEstrela.desenhar_tabuleiro(percepcao_mundo)
